...
export const tmdb = {
  getMovie: (type, page = 1) =>
    `${API_MOVIE}/movie/${type}?api_key=a4bf361f5cdff62a8cda329a39cc0303&page=${page}`,
  getDetailMovie: (id) =>
    `${API_MOVIE}/movie/${id}?api_key=a4bf361f5cdff62a8cda329a39cc0303`,
  getMeta: (type, id) =>
    `${API_MOVIE}/movie/${id}/${type}?api_key=a4bf361f5cdff62a8cda329a39cc0303`,
  searchMovie: (param, page = 1) =>
    `${API_MOVIE}/search/movie?api_key=a4bf361f5cdff62a8cda329a39cc0303&query=${param}&page=${page}`,
